...
Once the install script is done, please add Project White House to steam as a non steam game and change the name. Linux users will need to select the same Proton version and launch options (or just the SuperBLT launch options if they don't use any) as they use in current Payday. Once you've done this, you're ready to play. 
