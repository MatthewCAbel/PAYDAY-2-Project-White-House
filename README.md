...
# Installation
Download the script for your operating system from the releases page. Then run it through CMD (py downloader.py) for Windows or your terminal (python downloader.py) for windows.
